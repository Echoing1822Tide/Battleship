...
- `artifacts\release\BattleshipMaui-v1.9.12-win-x64\BattleshipMaui.exe`
- `artifacts\release\LANBattleshipMAUI-v2.2.12-win-x64\LANBattleshipMAUI.exe`
