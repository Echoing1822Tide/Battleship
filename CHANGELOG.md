...
- Public release distribution is a self-contained Windows `win-x64` zip named `LANBattleshipMAUI-v2.2.12-win-x64.zip`.
...
- Public release distribution is a self-contained Windows `win-x64` zip named `BattleshipMaui-v1.9.12-win-x64.zip`.
